...
=============
    ...
    2. Open a command prompt and navigate to the JavaSDK/JavaAPILib folder.
    ...
    4.In your own maven application, add the following lines which will refer to newly installed SDK: 
        <dependency>
            <groupId>JavaAPILib</groupId>
            <artifactId>JavaAPILib</artifactId>
...
Exporting JARs:
    ...
    3. Check the box beside "JavaAPILib" and click on "Finish".
